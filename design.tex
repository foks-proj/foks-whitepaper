...
To add $t_1$ to $t_2$ as a reader, the administrator can reduce $t_1$'s range to $[1, 0x80)$
and team $t_2$'s range to $[0x80, \infty)$. Now the property above is upheld,
since $[1,0x80) < [0x80, \infty)$.  Note that it still remains possible to add $t_2$ to 

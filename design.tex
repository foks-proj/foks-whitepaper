...
a datum for all of the user's devices --- it simply encrypts the data for the 
user's latest PUK.
...
Parties making changes to teams sign new team chain links much the same way as user devices
...
Whenever a client on the team interacts with another party, or even itself, it
...
previous pointers in the root block ensures that $n$ is approximately
...
team memberships from a user to silently suppress team rotations.\footnote{
...
signatures form a link in the sigchain. The server helps exchange encrypted PUK

...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[->, thick, auto, node distance=2.5cm]
        \node (k1) {$k_1^1$};
        \node (k2) [right of=k1] {$k_2^1$};
        \node (k3) [below of=k1] {$k_3^1$};
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[->, thick, auto, node distance=2.5cm]
        ...
        \node (k3) [below of=k1] {$k_3^1$};
        \node (k12) [left of=k1] {$k_1^2$};
        \node (k22) [above of=k2] {$k_2^2$};
        \node (k32) [below of=k3] {$k_3^2$};
        ...
        \draw[bend left=45] (k22) to (k32);
        \draw (k32) to (k3);

      \end{tikzpicture}
    \caption{After $u$ removes $v$, $t_1$ rotates, then $t_2$ rotates, and finally $t_3$ rotates.}
    \label{fig:cycle3}
\end{figure}

...
other authenticated data. Throughout, we refer to encrypting with Salsa20 as
...
Curve25519~\cite{bernstein2006curve25519}, and ML-KEM~\cite{nist-fips-203} using a
...
keypair, a Curve25519 keypair, and an ML-KEM keypair. Wherever public keys
are introduced, an EdDSA signature over the Curve25519 and ML-KEM public keys
...
for secret key seeds. As above, each secret seed gets its own secret-key 
...
key at every update, which symmetrically encrypts the SKMWKs. The session key gets encrypted
